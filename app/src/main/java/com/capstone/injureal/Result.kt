...
import com.capstone.injureal.databinding.ActivityResultBinding
import com.capstone.injureal.riwayat.AppDatabase
import com.capstone.injureal.riwayat.PredictionHistory
import com.capstone.injureal.ImageClassifierHelp
...
class Result : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (imageUriString != null) {
            ...
            val imageClassifierHelper = ImageClassifierHelp(
                contextValue = this,
                classifierListenerValue = object : ImageClassifierHelp.ClassifierListener {
